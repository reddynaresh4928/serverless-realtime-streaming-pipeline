          ...
          <div className="grid gap-4 md:grid-cols-4">
            ...
            <div className="rounded-3xl border border-white/10 bg-white/15 p-5 backdrop-blur-xl transition hover:bg-white/20">
              <div className="flex items-center gap-2">
                <ShieldCheck
                  ...
                  size={18}
                />
                <span className="font-semibold">Cloud Health</span>
              </div>
            ...
            <div className="rounded-3xl border border-white/10 bg-white/15 p-5 backdrop-blur-xl transition hover:bg-white/20">
              ...
              <button
                ...
                className="mt-4 flex w-full items-center justify-center gap-2 rounded-xl bg-red-600 px-4 py-2 font-semibold text-white transition hover:bg-red-700"
              >
                <LogOut size={16} />
                Logout
              </button>
